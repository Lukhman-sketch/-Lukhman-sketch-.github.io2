...
<div class="super_container" style="background-image:url(images/bg.jpg)">
	...
	<header class="header d-flex flex-row justify-content-end align-items-center" style="background-image:url(images/bg.jpg)">
		...
		<nav class="main_nav justify-self-end">
			<ul class="nav_items">
            <li><a href="index.php" onClick="myFunction()"><span>Kembali</span></a></li>
            <script>
function myFunction() {
	...
	<div class="fs_menu_container">
		...
		<nav class="fs_menu_nav">
			<ul class="fs_menu_list">
				<li><a href="#"><span><span>H</span></span></a></li>
				<li><a href="#"><span><span>S</span></span></a></li>
				<li><a href="#"><span><span>E</span></span></a></li>
				<li><a href="#"><span><span>B</span></span></a></li>
				<li><a href="#"><span><span>C</span></span></a></li>
			</ul>
		</nav>
	</div>
			...
			<div class="row">
				<div class="col-lg-6">
					<div class="home_content">
						<h1>TERIMA KASIH </h1>
						<span> kerana mendaftar</span>					</div>
				</div>
			</div>
		</div>
	</div>
